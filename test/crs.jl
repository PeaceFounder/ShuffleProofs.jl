using Verificatum: decode, unmarshal, Hash, PRG, RO, crs, encode
using Verificatum: value, order, bitsize # For seconduary checks
...
@test value(𝐡[1]^order(g)) == 1 # So I actually do obtain a group element
